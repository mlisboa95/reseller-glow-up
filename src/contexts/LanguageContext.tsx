...
const translations: Record<string, string> = {
  ...
  "atas.viewRecord": "Ver ata",
  "atas.back": "Voltar",
  "atas.category": "Categoria",
  "atas.categoryAll": "Todas",
  "atas.numero": "Ata",
  "atas.ambito": "Âmbito",
  "atas.vigencia": "Vigência",
  "atas.objeto": "Objeto",
  "atas.grupo": "Grupo",
  "atas.item": "Item",
  "atas.especificacao": "Especificação",
  "atas.unidade": "Und.",
  "atas.qtde": "Qtde.",
  "atas.fabricante": "Fabricante",
  "atas.valorUnitario": "Valor Unitário",
  "atas.valorTotal": "Valor Total",
  "atas.valorGlobal": "Valor global do registro de preços",
  "atas.semItens": "Itens em atualização",
