...
const heroPartners = [
  { name: "Arista", logo: aristaLogo, cls: "w-[88px] md:w-[104px] h-auto" },
  { name: "AWS", logo: awsLogo, cls: "w-[38px] md:w-[44px] h-auto" },
  { name: "Check Point", logo: checkpointLogo, cls: "w-[112px] md:w-[128px] h-auto" },
  { name: "Dahua", logo: dahuaLogo, cls: "w-[88px] md:w-[100px] h-auto" },
  { name: "Elastic", logo: elasticLogo, cls: "w-[96px] md:w-[112px] h-auto" },
  { name: "Everpure", logo: everpureLogo, cls: "w-[100px] md:w-[116px] h-auto" },
  { name: "ExaGrid", logo: exagridLogo, cls: "w-[88px] md:w-[100px] h-auto" },
  { name: "Extreme Networks", logo: extremeLogo, cls: "w-[112px] md:w-[128px] h-auto" },
  { name: "F5", logo: f5Logo, cls: "w-[36px] md:w-[42px] h-auto", noFilter: true },
  { name: "Gigamon", logo: gigamonLogo, cls: "w-[112px] md:w-[128px] h-auto" },
  { name: "Halcyon", logo: halcyonLogo, cls: "w-[120px] md:w-[140px] h-auto" },
  { name: "HPE", logo: hpeLogo, cls: "w-[64px] md:w-[72px] h-auto" },
  { name: "Invenzi", logo: invenziLogo, cls: "w-[112px] md:w-[128px] h-auto" },
  { name: "Lenovo", logo: lenovoLogo, cls: "w-[72px] md:w-[84px] h-auto" },
  { name: "Milestone", logo: milestoneLogo, cls: "w-[128px] md:w-[148px] h-auto" },
  { name: "Mitel", logo: mitelLogo, cls: "w-[104px] md:w-[120px] h-auto" },
  ...
  { name: "Riverbed", logo: riverbedLogo, cls: "w-[136px] md:w-[156px] h-auto" },
  { name: "RSA", logo: rsaLogo, cls: "w-[72px] md:w-[84px] h-auto" },
  { name: "Segura", logo: seguraLogo, cls: "w-[116px] md:w-[132px] h-auto" },
  { name: "SentinelOne", logo: sentineloneLogo, cls: "w-[108px] md:w-[124px] h-auto" },
  { name: "Thales", logo: thalesLogo, cls: "w-[96px] md:w-[112px] h-auto" },
  { name: "Veeam", logo: veeamLogo, cls: "w-[120px] md:w-[136px] h-auto" },
];
