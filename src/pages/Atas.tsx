...
const atas: Ata[] = [
  ...
  },
  {
    ...
    itens: [
      { grupo: 1, item: 1, especificacao: "Solução de Proteção de Perímetro Tipo I · Check Point Quantum 9200", unidade: "Und.", qtde: 4, fabricante: "Check Point", valorUnitario: 545000.0, valorTotal: 2180000.0 },
      { grupo: 1, item: 2, especificacao: "Solução de Proteção de Perímetro Tipo II · Check Point Quantum 1600", unidade: "Und.", qtde: 16, fabricante: "Check Point", valorUnitario: 54000.0, valorTotal: 864000.0 },
      { grupo: 1, item: 3, especificacao: "Solução de Proteção de Perímetro Tipo III · Check Point Spark 1575", unidade: "Und.", qtde: 40, fabricante: "Check Point", valorUnitario: 26200.0, valorTotal: 1048000.0 },
      { grupo: 1, item: 4, especificacao: "Solução de Gerenciamento Centralizado (5 Equipamentos) · Check Point NGSM 5 Devices", unidade: "Und.", qtde: 4, fabricante: "Check Point", valorUnitario: 108000.0, valorTotal: 432000.0 },
      { grupo: 1, item: 5, especificacao: "Solução de Gerenciamento Centralizado (10 Equipamentos) · Check Point NGSM 10 Devices", unidade: "Und.", qtde: 4, fabricante: "Check Point", valorUnitario: 205000.0, valorTotal: 820000.0 },
      { grupo: 1, item: 6, especificacao: "Solução de Proteção de Dispositivos · Check Point Harmony Endpoint Advanced", unidade: "Und.", qtde: 1500, fabricante: "Check Point", valorUnitario: 875.0, valorTotal: 1312500.0 },
      { grupo: 1, item: 7, especificacao: "Solução de Proteção de Plataforma de Colaboração · Check Point Harmony Mail+Collaboration", unidade: "Und.", qtde: 1500, fabricante: "Check Point", valorUnitario: 890.0, valorTotal: 1335000.0 },
      { grupo: 1, item: 8, especificacao: "Serviços de Instalação", unidade: "Und.", qtde: 1, fabricante: "Mahvla", valorUnitario: 43000.0, valorTotal: 43000.0 },
      { grupo: 1, item: 9, especificacao: "Serviços de Treinamento", unidade: "Und.", qtde: 1, fabricante: "Mahvla", valorUnitario: 41500.0, valorTotal: 41500.0 },
      { grupo: 1, item: 10, especificacao: "Serviços de Consultoria", unidade: "Und.", qtde: 200, fabricante: "Mahvla", valorUnitario: 730.0, valorTotal: 146000.0 },
    ],
  },
];
          ...
          <Table>
            ...
            <TableBody>
              ...
              <TableRow className="bg-gray-100 hover:bg-gray-100">
                <TableCell colSpan={5} className="text-sm text-gray-900 text-right font-bold">
                  {t("atas.valorGlobal")}
                </TableCell>
